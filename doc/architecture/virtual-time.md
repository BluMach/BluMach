...
such. Version 15 also routes memory and I/O transfers through the same BCU as
...
as well; other operand-bearing boundaries stay unresolved until their EXU
position is known.
It is not
...
- HALT/idle, wake-up, reset and invalid-progress paths have initial tests.
  ...
  CPU migrates.
- The existing PCS 86 suite remains green. V30 observation version 15 advances
